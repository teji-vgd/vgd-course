...
import playIcon from '../assets/play-circle-white.svg';
...
<div className='wrap-row two-col'>
    ...
    In p5.js, the program the computer to draw pictures and animations onto a `canvas`. You can create a canvas and draw shapes on the screen and program movements for the shapes.
...
## Sprites
<div className='wrap-row half-row'>
    <div className='writingSection'>
    ...
    Click <img src={playIcon} /> above to run your changed code.
    </div>
...
Press <img src={playIcon} /> to see the gravity affect the sprite on the right.
